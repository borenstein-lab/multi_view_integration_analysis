...
all_utests <- get_u_tests(sens_analysis_modules2, diablo_input)
sens_analysis_modules2 <- sens_analysis_modules2 %>%
  left_join(all_utests %>% select(dataset, feature, increased_in), by = c('dataset','original_feature' = 'feature'))
